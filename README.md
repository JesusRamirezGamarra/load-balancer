...
8. Luego, modificar la configuración para que todas las consultas a /api/randoms sean redirigidas a un cluster de servidores gestionado desde nginx, repartiéndolas equitativamente entre 4 instancias escuchando en los puertos 8082, 8083, 8084 y 8085 respectivamente.
9.  Incluir el archivo de configuración de nginx junto con el proyecto.
...
node src/index.js --MODE=dev --PORT=8080 --MODO=FORK
